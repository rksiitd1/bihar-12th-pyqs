...
def main():
    ...
    input_folder = pathlib.Path("geography_papers")
    output_folder = pathlib.Path("geography_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"geo_{year}.pdf"
        output_json = output_folder / f"geo_{year}.json"
