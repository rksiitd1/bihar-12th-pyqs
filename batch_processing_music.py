...
def main():
    ...
    input_folder = pathlib.Path("music_papers")
    output_folder = pathlib.Path("music_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"mus_{year}.pdf"
        output_json = output_folder / f"music_{year}.json"
