...
def main():
    ...
    input_folder = pathlib.Path("philosophy_papers")
    output_folder = pathlib.Path("philosophy_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"phil_{year}.pdf"
        output_json = output_folder / f"philosophy_{year}.json"
