...
def main():
    ...
    input_folder = pathlib.Path("economics_papers")
    output_folder = pathlib.Path("economics_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"eco_{year}.pdf"
        output_json = output_folder / f"eco_{year}.json"
