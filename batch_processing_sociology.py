...
def main():
    ...
    input_folder = pathlib.Path("sociology_papers")
    output_folder = pathlib.Path("sociology_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"soc_{year}.pdf"
        output_json = output_folder / f"sociology_{year}.json"
