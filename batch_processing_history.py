...
def main():
    ...
    input_folder = pathlib.Path("history_papers")
    output_folder = pathlib.Path("history_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"his_{year}.pdf"
        output_json = output_folder / f"his_{year}.json"
