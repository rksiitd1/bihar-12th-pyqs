...
def main():
    ...
    input_folder = pathlib.Path("political_science_papers")
    output_folder = pathlib.Path("political_science_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"psci_{year}.pdf"
        output_json = output_folder / f"psci_{year}.json"
