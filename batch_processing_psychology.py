...
def main():
    ...
    input_folder = pathlib.Path("psychology_papers")
    output_folder = pathlib.Path("psychology_data")
    output_folder.mkdir(exist_ok=True)

    for year in years:
        input_pdf = input_folder / f"psy_{year}.pdf"
        output_json = output_folder / f"psy_{year}.json"
